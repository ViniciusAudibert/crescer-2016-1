...
public class IrishDwarfTest {
    ...
    public void tentaSorteUmItem(){
        ...
        dwarf.tentarSorte();
        assertEquals(dwarf.getAtributos().getInventario().getItens().get(0).getQuantidade(), 3002);
    }
    ...
    public void tentaSorteDoisItens(){
        ...
        IrishDwarf dwarf = new IrishDwarf("Anao",dataNascimento);
        dwarf.getAtributos().getInventario().adicionarItem(new Item(2,"Adaga"));
        dwarf.getAtributos().getInventario().adicionarItem(new Item(4,"Escudo"));
        for(int i = 0; i <= 2; i++){
            dwarf.receberFlecha();
        }
        dwarf.tentarSorte();
        assertEquals(dwarf.getAtributos().getInventario().getItens().get(0).getQuantidade(), 3002);
        assertEquals(dwarf.getAtributos().getInventario().getItens().get(1).getQuantidade(), 10004);
    }
}