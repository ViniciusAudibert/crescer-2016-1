...
public class DicionarioSindarin {
    public static void main(String[] args){
        ...
        System.out.println("Bem vindo ao tradutor de sindarin!! Escolha a linguagem: ");
        System.out.println("[P]ortugues [I]ngles");
        String idioma = s.nextLine();
        System.out.println("Digite a palavra em sindarin");
    ...
    private static TradutorSindarin criarTradutor(String idioma){
        ...
        private static void rodaExemplosHashMap(){
